...
<script>
	...
	function DoLike()
	{
		$.ajax({
			type    : "post",
			url     : "/kick_off_view/jsp/video/like_hateOnOff.jsp",
			data    : 
			{
				post_no : "<%= no %>",
				like_hate : "l"
	...
	function DoDelete()
	{
		...
		document.location = "/kick_off_view/jsp/video/video_delete.jsp?no=<%= no %>&mcate=<%= mcate %>&scate=<%= scate %>&pageno=<%= pageno %>&sort=<%= sort %>&keyword=<%= keyword %>&search_type=<%= search_type %>";
	}
	function DoBack()
	{
		document.location = "/kick_off_view/jsp/video/video.jsp?no=<%= no %>&mcate=<%= mcate %>&scate=<%= scate %>&pageno=<%= pageno %>&sort=<%= sort %>&keyword=<%= keyword %>&search_type=<%= search_type %>"
	}
	function DoModify()
	{
		document.location = "/kick_off_view/jsp/video/video_modify.jsp?no=<%= no %>&mcate=<%= mcate %>&scate=<%= scate %>&pageno=<%= pageno %>&sort=<%= sort %>&keyword=<%= keyword %>&search_type=<%= search_type %>"
	}
	function ReplyList()
	{
		$.ajax({
